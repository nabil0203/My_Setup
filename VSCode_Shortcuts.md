...
| `Ctrl + J`            | Open/Close terminal 🖥️     |
| `Ctrl + B`            | Open/Close Explorer 📂      |
| `Ctrl + L`            | Selects the whole line ✂️   |
| `clear`               | Clears the Terminal🧹   |
| `Ctrl + L` (terminal) | Refresh terminal 🔄         |
| `Ctrl + Enter`        | Next line from any point ➡️ |
| `Ctrl + Shift + K`    | Delete line 🗑️             |
| `Shift + Alt + F`     | Format the code 🎨          |
| `Shift + Alt + ↓`     | Copy and paste the line 📋  |
| `ALT + ↑`             | Move the line up ⬆️         |
| `ALT + ↓`             | Move the line down ⬇️       |
| `ALT + →`             | Navigate tabs ↪️            |
| `ALT + mouse click`   | Selects Multiple points ✍️  |
